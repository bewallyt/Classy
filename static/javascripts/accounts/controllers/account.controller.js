/**
 * AccountController
 * @namespace classy.accounts.controllers
 */
(function () {

    angular
        .module('classy.accounts.controllers')
        .controller('AccountController', AccountController);

    AccountController.$inject = ['$location', 'Authentication', 'Posts', 'Account', 'Snackbar', '$scope', 'Groups', 'Access', '$mdSidenav', '$log'];

    function AccountController($location, Authentication, Posts, Account, Snackbar, $scope, Groups, Access, $mdSidenav, $log) {
